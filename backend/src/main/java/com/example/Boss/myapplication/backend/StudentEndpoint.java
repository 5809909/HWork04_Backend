...
@Api(
        ...
        namespace = @ApiNamespace(
                ownerDomain = "backend.myapplication.Boss.example.com",
                ownerName = "backend.myapplication.Boss.example.com",
                packagePath = ""
        )
)
public class StudentEndpoint {
    ...
    public Student insert(@Named("id") Long id, @Named("name") String name, @Named("lastName") String lastName) {
